...
**Context** : in the M&A case study "Printicomm's Proposed Acquisition of Digitech: Negotiating Price and Form of Payment", company sellers are offered earnout contracts which payoff depends on the operating income generated by the company in the next few years. Those contracts can be value like a call option under some assumptions of growth and operating margin.
